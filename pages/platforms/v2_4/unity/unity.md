...
SDK Developer Guide Release 2.4
...
{% include custom/download_link.html build_version="2.4" platform="unity" %}
...
* [How to analyze a camera feed]({{ site.baseurl }}/v2_4/unity/analyze-camera/)
* [How to analyze a recorded video file]({{ site.baseurl }}/v2_4/unity/analyze-video/)
* [How to analyze a video frame stream]({{ site.baseurl }}/v2_4/unity/analyze-frames/)
...
## Class Documentation
The classes that come with this asset are viewable [here](/pages/platforms/v2_4/unity/Help/index.html).
...
* Android builds require installation of [JDK 8](http://www.oracle.com/technetwork/java/javase/documentation/jdk8-doc-downloads-2133158.html), and the Unity IDE must be configured to use it (in Preferences, select the External Tools tab, then under the Android heading, specify the JDK).  If you use an earlier JDK, you may see an error like "Unable to convert classes into dex-format" when the build gets to the "Converting Java classes to dex-format" step,
