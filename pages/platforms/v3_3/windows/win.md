...
{% include custom/download_link.html build_version="3.3.0-" platform="windows" %}
...
&nbsp;&nbsp;&nbsp;&nbsp;A dynamic library, ```opencv_ffmpeg.dll``` is required by VideoDetector [[c++]({{ site.baseurl }}/pages/platforms/v3_3/windows/classdocs/affdex-native/classaffdex_1_1_video_detector.html)], [[c#]({{ site.baseurl }}/pages/platforms/v3_3/windows/classdocs/Affdex/html/6e4b1996-68bf-4750-439a-731c2be17537.htm)] in runtime for the video decoding.

##### 3. Capture and analyze faces

Facial images can be captured from different sources. For each of the different sources, the SDK defines a detector class that can handle processing images acquired from that source:

* [How to analyze a camera feed]({{ site.baseurl }}/v3_3/windows/analyze-camera/)
* [How to analyze a recorded video file]({{ site.baseurl }}/v3_3/windows/analyze-video/)
* [How to analyze a video frame stream]({{ site.baseurl }}/v3_3/windows/analyze-frames/)
* [How to analyze a photo]({{ site.baseurl }}/v3_3/windows/analyze-photo/)
...
## Class documentation
* .NET (C#) Namespace: [[HTML]({{ site.baseurl }}/pages/platforms/v3_3/windows/classdocs/Affdex/index.html)]
* C++ Namespace: [[HTML]({{ site.baseurl }}/pages/platforms/v3_3/windows/classdocs/affdex-native/namespaceaffdex.html)]
